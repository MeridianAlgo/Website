        ...
        <section className="py-20 min-h-screen flex items-center justify-center bg-transparent">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="rounded-3xl p-12 bg-transparent">
              <div className="bg-gradient-to-r from-orange-500 to-orange-400 rounded-full p-6 w-fit mx-auto mb-8">
              ...
              <button
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-600 hover:to-orange-500 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105 font-inter"
              >
                ...
                <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 hover:border-orange-400/30 transition-all duration-300 p-6 rounded-2xl">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/MeridianAlgo" className="text-orange-400 hover:text-orange-400 transition-colors duration-300">
              ...
              <div className="mb-12">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="bg-gray-800/50 hover:bg-orange-400 p-3 rounded-xl transition-all duration-300 hover:scale-110 border border-gray-700/50 hover:border-orange-400/50"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full bg-gray-900/50 border border-gray-600/50 rounded-xl px-4 py-4 text-white placeholder-gray-400 focus:border-orange-400 focus:outline-none transition-all duration-300 hover:border-gray-500"
                ...
                <div>
                  ...
                  <select
                    id="interest"
                    name="interest"
                    className="w-full bg-gray-900/50 border border-gray-600/50 rounded-xl px-4 py-4 text-white focus:border-orange-400 focus:outline-none transition-all duration-300 hover:border-gray-500"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full bg-gray-900/50 border border-gray-600/50 rounded-xl px-4 py-4 text-white placeholder-gray-400 focus:border-orange-400 focus:outline-none transition-all duration-300 resize-none hover:border-gray-500"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-600 hover:to-orange-500 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-xl transition-all duration-300 hover:transform hover:scale-[1.02] flex items-center justify-center space-x-3 hover:shadow-lg hover:shadow-orange-400/25"
                >
